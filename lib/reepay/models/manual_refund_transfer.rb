...
module Reepay
  ...
  class ManualRefundTransfer
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["cash", "chargeback", "bank_transfer", "check", "other"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["cash", "chargeback", "bank_transfer", "check", "other"])
    ...
    def hash
      [comment, reference, method, payment_date].hash
    end
