...
module Reepay
  ...
  class Discount
    ...
    # Discount state `active` or `deleted`.
    attr_accessor :state
    ...
    def hash
      [handle, name, description, amount, percentage, state, deleted, created, apply_to, fixed_count, fixed_period_unit, fixed_period].hash
    end
