...
module Reepay
  ...
  class CreateRefund
    ...
    # Refund credit note lines to give detailed information for credit note. Either this or `amount` must be provided.
    attr_accessor :note_lines
    ...
    def self.swagger_types
      {
        ...
        :'amount' => :'Integer',
        :'text' => :'String',
        :'note_lines' => :'Array<CreateCreditNoteLine>',
        :'manual_transfer' => :'ManualRefundTransfer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'note_lines')
        if (value = attributes[:'note_lines']).is_a?(Array)
          self.note_lines = value
        end
      end
    ...
    def hash
      [invoice, key, amount, text, note_lines, manual_transfer].hash
    end
