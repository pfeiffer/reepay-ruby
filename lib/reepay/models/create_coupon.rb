...
module Reepay
  ...
  class CreateCoupon
    ...
    def list_invalid_properties
      ...
      if !@max_redemptions.nil? && @max_redemptions < 1
        invalid_properties.push("invalid value for 'max_redemptions', must be greater than or equal to 1.")
      end
    ...
    def valid?
      ...
      return false if !@max_redemptions.nil? && @max_redemptions < 1
      return true
    end
    ...
    def max_redemptions=(max_redemptions)
      ...
      if !max_redemptions.nil? && max_redemptions < 1
        fail ArgumentError, "invalid value for 'max_redemptions', must be greater than or equal to 1."
      end
    ...
    def hash
      [name, handle, code, discount, all_plans, eligible_plans, max_redemptions, valid_until].hash
    end
