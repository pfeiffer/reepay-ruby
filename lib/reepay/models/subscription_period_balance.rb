...
module Reepay
  ...
  class SubscriptionPeriodBalance
    ...
    # The amount that can be credited for the period invoice
    attr_accessor :creditable

    # Full period amount for period
    attr_accessor :period_amount

    # The amount that can be online refunded on the subscription
    attr_accessor :online_refundable
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consumed')
      ...
      if attributes.has_key?(:'creditable')
        self.creditable = attributes[:'creditable']
      end

      if attributes.has_key?(:'period_amount')
        self.period_amount = attributes[:'period_amount']
      end

      if attributes.has_key?(:'online_refundable')
        self.online_refundable = attributes[:'online_refundable']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          creditable == o.creditable &&
          period_amount == o.period_amount &&
          online_refundable == o.online_refundable
    end
    ...
    def hash
      [date, invoice, paid, consumed, remaining, creditable, period_amount, online_refundable].hash
    end
