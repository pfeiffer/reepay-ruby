...
module Reepay
  ...
  class ExpireSubscription
    ...
    def valid?
      compensation_method_validator = EnumAttributeValidator.new('String', ["full_refund", "prorated_refund", "none"])
    ...
    def compensation_method=(compensation_method)
      validator = EnumAttributeValidator.new('String', ["full_refund", "prorated_refund", "none"])
