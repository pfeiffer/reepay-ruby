...
module Reepay
  ...
  class ChangedSubscription
    ...
    # Object describing the result of a subscription change
    attr_accessor :change_journal
    ...
    def self.swagger_types
      {
        ...
        :'change_journal' => :'SubscriptionChangeJournal'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'change_journal')
        self.change_journal = attributes[:'change_journal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          change_journal == o.change_journal
    end
