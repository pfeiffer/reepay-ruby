...
module Reepay
  ...
  class CreateCustomerInvoice
    ...
    # Optional settle to perform after creation
    attr_accessor :settle

    # Order lines for the invoice
    attr_accessor :order_lines

    # Optional manual transfer to settle invoice with after creation.
    ...
    def hash
      [handle, settle, order_lines, manual_transfer, billing_address, shipping_address].hash
    end
