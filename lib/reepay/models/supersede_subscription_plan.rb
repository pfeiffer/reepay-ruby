...
module Reepay
  ...
  class SupersedeSubscriptionPlan
    # Name of the plan
    attr_accessor :name
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'supersede_mode')
        self.supersede_mode = attributes[:'supersede_mode']
      end
    ...
    def valid?
      ...
      supersede_mode_validator = EnumAttributeValidator.new('String', ["no_sub_update", "scheduled_sub_update", "instant_sub_update"])
      return false unless supersede_mode_validator.valid?(@supersede_mode)
      return true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] supersede_mode Object to be assigned
    def supersede_mode=(supersede_mode)
      validator = EnumAttributeValidator.new('String', ["no_sub_update", "scheduled_sub_update", "instant_sub_update"])
      unless validator.valid?(supersede_mode)
        fail ArgumentError, "invalid value for 'supersede_mode', must be one of #{validator.allowable_values}."
      end
      @supersede_mode = supersede_mode
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          supersede_mode == o.supersede_mode
    end
