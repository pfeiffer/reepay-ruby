...
module Reepay
  ...
  class ManualSettleTransfer
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["cash", "bank_transfer", "check", "other"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["cash", "bank_transfer", "check", "other"])
