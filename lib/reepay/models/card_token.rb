...
module Reepay
  ...
  class CardToken
    # Add card to customer by card token (`ct_...`). A card token can be generated with [Reepay Token](https://docs.reepay.com/token/) or [Reepay JS Library](https://docs.reepay.com/js/).
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'card_token')
