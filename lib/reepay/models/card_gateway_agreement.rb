...
module Reepay
  ...
  class CardGatewayAgreement
    ...
    def hash
      [provider, card_types, provider_settings, threed_secure, threed_secure_recurring, secured_by_nets, secured_by_nets_recurring, gw_ref].hash
    end
