...
module Reepay
  ...
  class Plan
    ...
    # Currency for the subscription plan in [ISO 4217](http://da.wikipedia.org/wiki/ISO_4217) three letter alpha code
    attr_accessor :currency

    # Date when the subscripton plan was created. In ISO-8601 extended offset date-time format.
