...
module Reepay
  ...
  class CreateSubscription
    ...
    # The payment method source if signup method `source`. Either an existing payment method for the customer, e.g. existing card id `ca_...` or a card token `ct_...` generated with [Reepay Token](https://docs.reepay.com/token/) or [Reepay JS Library](https://docs.reepay.com/js/).
    ...
    attr_accessor :signup_method

    # If the subscription is eligible to bill for the first period right away, this option will make the creation conditional on a successful payment of the first invoice. Will require a signup method of `source`. Default is false.
    attr_accessor :conditional_create
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'signup_method')
        self.signup_method = attributes[:'signup_method']
      end

      if attributes.has_key?(:'conditional_create')
        self.conditional_create = attributes[:'conditional_create']
      end
    ...
    def list_invalid_properties
      ...
      if @signup_method.nil?
        invalid_properties.push("invalid value for 'signup_method', signup_method cannot be nil.")
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          signup_method == o.signup_method &&
          conditional_create == o.conditional_create
    end
