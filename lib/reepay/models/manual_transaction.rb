...
module Reepay
  ...
  class ManualTransaction
    ...
    def valid?
      ...
      method_validator = EnumAttributeValidator.new('String', ["cash", "bank_transfer", "check", "chargeback", "other"])
    ...
    def method=(method)
      validator = EnumAttributeValidator.new('String', ["cash", "bank_transfer", "check", "chargeback", "other"])
    ...
    def hash
      [method, comment, reference, payment_date].hash
    end
